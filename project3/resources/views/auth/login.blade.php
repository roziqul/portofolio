        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="{{ asset('adminAssets/img/stisla-fill.svg') }}" alt="logo" width="80"
                        ...
                        <p class="text-muted">
                          Jika belum memiliki akun silahkan menemui operator perpustakaan untuk pendataan dan aktivasi akun :)
                        </p>
                        <form method="post" action="{{('login')}}" class="needs-validation" novalidate="" enctype=multipart/form-data>
                            @csrf
                            <div class="form-group">
                                <label for="name">Username / NISN</label>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Smart Library System 2024. In Collaboration with Ottalabs High School
                        </div>
                    </div>
                </div>
