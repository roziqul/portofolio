                        ...
                        <form action="#" method="post" id="formTambah">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="name" id="name" value="SmartLib - V1">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="name" id="name" value="Jl. Akjasfkjanfqwbfqlfqlfqwfqw">
                                    <div class="invalid-feedback" for="name"></div>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="name" id="name" value="012491121231 (Pak Agus)">
                                    <div class="invalid-feedback" for="name"></div>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="name" id="name" value="Rp. 500,00">
                                    <div class="invalid-feedback" for="name"></div>
                                </div>
                            </div>
