                        ...
                        <table class="table table-striped table-sm table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="5" id="alamat_op" style="width: 70%;">{{$val->name}}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Category</th>
                                    <td colspan="5" id="alamat_op" style="width: 70%;">
                                        @foreach ($category as $val)
                                        <div class="badge badge-primary">{{$val->name}}</div>
                                        @endforeach
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Created Date</th>
                                    <td colspan="5" id="alamat_op" style="width: 70%;">{{$val->created_at}}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Last Updated</th>
                                    <td colspan="5" id="alamat_op" style="width: 70%;">{{$val->updated_at}}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Verified by</th>
                                    <td colspan="5" id="alamat_op" style="width: 70%;">{{$val->updated_by}}</td>
                                </tr>
                                <tr>
                                    <th scope="row">Total Catalog</th>
                                    <td colspan="5" id="alamat_op" style="width: 70%;">{{$count}}</td>
                                </tr>
                            </tbody>
                            @endforeach
                        </table>
