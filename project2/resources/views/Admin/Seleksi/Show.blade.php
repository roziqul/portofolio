    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                @foreach ($siswa as $s)
                <h3 class="card-title">Detail Data Seleksi No. {{$s->id}}</h3> 
                @endforeach
            </div>
            <div class="card-body">
                <form action="{{ route('post.seleksi')}}" method="POST" enctype="multipart/form-data" style="display: block;">
                    @csrf
                        @foreach ($siswa as $s)
                            <h3>Data Siswa</h3>
                            @foreach ($user as $u)
                            ...
                            @foreach ($daftar as $d)
                                <div id="nilai_div">
                                    ...
                                    <div class="form-group row" style="margin-bottom: 20px; margin-top: 5px;">
                                        <label class="col-sm-2 col-form-label">&nbsp;</label>
                                        @foreach ($archieve as $b)                                                                
                                        <div class="col" style="text-align: center;">
                                            <a class="btn btn-primary" href="{{$b->raport1}}" target="_blank">View Raport</a>
                                        </div>
                                        <div class="col" style="text-align: center;">
                                            <a class="btn btn-primary" href="{{$b->raport2}}" target="_blank">View Raport</a>
                                        </div>
                                        <div class="col" style="text-align: center;">
                                            <a class="btn btn-primary" href="{{$b->raport3}}" target="_blank">View Raport</a>
                                        </div>
                                        <div class="col" style="text-align: center;">
                                            <a class="btn btn-primary" href="{{$b->raport4}}" target="_blank">View Raport</a>
                                        </div>
                                        <div class="col" style="text-align: center;">
                                            <a class="btn btn-primary" href="{{$b->raport5}}" target="_blank">View Raport</a>
                                        </div>
                                        @endforeach
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col">
                                            <input type="number" class="form-control" name="point" value="{{$d->point}}" readonly>   
                                        </div>  
                                    </div>
                                </div>
                                
                                <div class="card-footer">
                                    <a href="{{ route('filterSeleksi')}}" class="btn btn-primary float-left">
                                    ...
                                    <div class="float-right">
                                        @if ($d->status == 'WAITING VERIFICATION')
                                            <button type="submit" class="btn btn-danger" name="status" value="NOT VERIFIED">NOT VERIFIED</button>
                                            <button type="submit" class="btn btn-success" name="status" value="VERIFIED">VERIFIED</button>
                                        @elseif ($d->status == 'VERIFIED' && auth()->user()->role_id == 1)
